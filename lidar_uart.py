...
try:
    ...
    for counter in range (10000000):
        ...
        if counter % 120 == 0 and setup_attempt <= 3:
            ...
            os.system("sudo python3 /home/pi/curva/lightup_gpio18_green.py")
        ...
        if difference > tolerance:
            ...
            os.system("sudo python3 /home/pi/curva/lightup_gpio18_red.py")
        else:
            print ("Object not detected, lights off")
            os.system("sudo python3 /home/pi/curva/clear_leds_gpio18.py")
